Below is a **complete, ready-to-copy `README.md`** that now **highlights the results and includes the plots** generated by the notebook (the notebook already creates a few visualisations – a **station-level availability heatmap**, a **distribution of bikes/docks**, and a **top-10 stations bar chart**).  
Feel free to replace the placeholder image URLs with the actual PNGs you export from the notebook.
